...
>  Software Engineer currently working fully remote from the United States.  I have
>  been in enterprise software and infrastructure engineering for the past 13.49
...
Graduated with a Bachelor's in Computer Science from Michigan Technological University.

## Contact Info:
**email**: [ryan@rdoyle.net](mailto:ryan@rdoyle.net); **linkedin**: [rcdoyle](https://linkedin.com/in/rcdoyle)
